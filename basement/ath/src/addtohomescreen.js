...
ath.intl = {
	...
	en_us: {
		ios: '<br>Offline reading? Full-screen?<br>Install the App!<br><br>tap <img src="basement/ath/imgs/ios.png" width="20"> and select<br><strong>Add to Home Screen</strong>.',
